 ...
 */
final class Version20240701071022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE trip_activity (id INT AUTO_INCREMENT NOT NULL, trip_id INT DEFAULT NULL, activity_id INT DEFAULT NULL, INDEX IDX_4253A4AA5BC2E0E (trip_id), INDEX IDX_4253A4A81C06096 (activity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
